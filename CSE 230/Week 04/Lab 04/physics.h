...
public:
    ...
    double dx = abs(posDif[1].getX() - posDif[0].getX());
    double dy = abs(posDif[1].getY() - posDif[0].getY());
    double y = posDif[1].getY();
    double x = posDif[1].getX();
    double t = 1;
    double speed;
    ...
    ***************************************************/
    ...
    void setPosDif(Point prePos, Point curPos, int frame) {
        if (frame == 30) {
            posDif[0] = prePos;
            posDif[1] = curPos;
        }
    ...
    ****************************************************************/
    ...
    void physics(double angle)
    {
        aRadians = convertRadiansFromDegrees(angle);
    ...
    void getSpeed(int frame) {
        if (frame == 30) {
            speed = sqrt(pow(posDif[1].getX() - posDif[0].getX(), 2) + 
                pow(posDif[1].getY() - posDif[0].getY(), 2));
        }
    }
};